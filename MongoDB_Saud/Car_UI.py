...
label = tk.Label(window,text="    Car Entry Form!",width=30,borderwidth=2,relief="solid",height=2,bg="dark green",anchor="center")
label.config(font=("Courier" "Bold",20))
label.grid(column=2,row=1)

label = tk.Label(window,text="CarID",borderwidth=1,relief="solid",width=20,height=2,bg="dark green",anchor="center",font="arial" "bold")
...
label = tk.Label(window,text="RegNo",borderwidth=1,relief="solid",width=20,height=2,bg="dark green",anchor="center",font="arial" "bold")
...
label = tk.Label(window,text="Manufacturer ",width=20,height=2,borderwidth=1,relief="solid",bg="dark green",anchor="center",font="arial" "bold")
...
label = tk.Label(window,text="CarModel: ",borderwidth=1,relief="solid",width=20,height=2,bg="dark green",anchor="center",font="arial" "bold")
...
label = tk.Label(window,text="YearOfPurchase: ",borderwidth=1,relief="solid",width=20,height=2,bg="dark green",anchor="center",font="arial" "bold")
label.grid(column=1,row=6)
cPurchase=tk.StringVar() 
custPurchase=tk.Entry(window, textvariable=cPurchase)
custPurchase.grid(column=2,row=6)

label = tk.Label(window,text="Availability: ",borderwidth=1,relief="solid",width=20,height=2,bg="dark green",anchor="center",font="arial" "bold")
